...
final class PaymentCancelController extends AbstractController
{
    ...
    #[Route(path: '/checkout-payment/cancel', methods: ['GET'])]
    public function __invoke(Request $request): Response
    {
        ...
        return $this->render('@CheckoutPayment/payment/cancel.html.twig', [
            'session' => $session,
        ]);
    }
}
